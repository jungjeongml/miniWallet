...
describe('genesis block', ()=>{
  it('genesis block is true?', ()=>{
    ...
    expect(GENESIS.hash).toBe('84ffab55c48e36cc480e2fd4c4bb0dc5ee1bb2d41a4f2a78a1533a8bb7df8370') //16진수
    expect(GENESIS.merkleRoot).toBe("DC24B19FB7508611ACD8AD17F401753670CFD8DD1BEBEF9C875125E98D82E3D8")
    expect(GENESIS.previousHash).toBe('0'.repeat(64)) //임의의값 넣은거임.
